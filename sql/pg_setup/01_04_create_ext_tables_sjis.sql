...
CREATE UNIQUE INDEX ingestion_files_PKI
  ON ext.ingestion_files(file_id);

ALTER TABLE ext.ingestion_files
  ADD CONSTRAINT ingestion_files_PKC PRIMARY KEY (file_id);
...
CREATE UNIQUE INDEX ingestion_runs_PKI
  ON ext.ingestion_runs(run_id);

ALTER TABLE ext.ingestion_runs
  ADD CONSTRAINT ingestion_runs_PKC PRIMARY KEY (run_id);

-- ext.raw_loinc_codes
-- * BackupToTempTable
DROP TABLE if exists ext.raw_loinc_codes CASCADE;

-- * RestoreFromTempTable
CREATE TABLE ext.raw_loinc_codes (
  loinc_num TEXT DEFAULT '' NOT NULL
  , component TEXT
  , property TEXT
  , time_aspct TEXT
  , system TEXT
...
-- ext.raw_jlac11_codes
-- * BackupToTempTable
DROP TABLE if exists ext.raw_jlac11_codes CASCADE;

-- * RestoreFromTempTable
CREATE TABLE ext.raw_jlac11_codes (
...
-- ext.agency_codes
-- * BackupToTempTable
DROP TABLE if exists ext.agency_codes CASCADE;

-- * RestoreFromTempTable
CREATE TABLE ext.agency_codes (
  agency_code TEXT DEFAULT '' NOT NULL
  , agency_name TEXT DEFAULT '' NOT NULL
  , run_id BIGINT DEFAULT 0 NOT NULL
) ;

-- ext.raw_designated_agencies
-- * BackupToTempTable
DROP TABLE if exists ext.raw_designated_agencies CASCADE;

-- * RestoreFromTempTable
CREATE TABLE ext.raw_designated_agencies (
  ...
  , agency_type TEXT DEFAULT '' NOT NULL
...
CREATE TABLE ext.jis_compat_maps (
  ...
  , run_id BINGINT DEFAULT 0 NOT NULL
) ;
...
-- ext.raw_postal_codes
-- * BackupToTempTable
DROP TABLE if exists ext.raw_postal_codes CASCADE;

-- * RestoreFromTempTable
CREATE TABLE ext.raw_postal_codes (
  local_government_code TEXT NOT NULL
  , old_postal_code5 TEXT DEFAULT '' NOT NULL
  , postal_code7 TEXT DEFAULT '' NOT NULL
  , prefecture_katakana TEXT DEFAULT '' NOT NULL
  , city_katakana TEXT DEFAULT '' NOT NULL
  , town_katakana TEXT DEFAULT '' NOT NULL
  , prefecture TEXT DEFAULT '' NOT NULL
...
COMMENT ON TABLE ext.raw_loinc_codes IS 'ext.raw_loinc_codes';
COMMENT ON COLUMN ext.raw_loinc_codes.loinc_num IS 'LOINC_NUM';
COMMENT ON COLUMN ext.raw_loinc_codes.component IS 'COMPONENT';
COMMENT ON COLUMN ext.raw_loinc_codes.property IS 'PROPERTY';
COMMENT ON COLUMN ext.raw_loinc_codes.time_aspct IS 'TIME_ASPCT';
COMMENT ON COLUMN ext.raw_loinc_codes.system IS 'SYSTEM';
COMMENT ON COLUMN ext.raw_loinc_codes.scale_typ IS 'SCALE_TYP';
COMMENT ON COLUMN ext.raw_loinc_codes.method_typ IS 'METHOD_TYP';
COMMENT ON COLUMN ext.raw_loinc_codes.class IS 'CLASS';
COMMENT ON COLUMN ext.raw_loinc_codes.classtype IS 'CLASSTYPE';
COMMENT ON COLUMN ext.raw_loinc_codes.long_common_name IS 'LONG_COMMON_NAME';
COMMENT ON COLUMN ext.raw_loinc_codes.shortname IS 'SHORTNAME';
COMMENT ON COLUMN ext.raw_loinc_codes.external_copyright_notice IS 'EXTERNAL_COPYRIGHT_NOTICE';
COMMENT ON COLUMN ext.raw_loinc_codes.status IS 'STATUS';
COMMENT ON COLUMN ext.raw_loinc_codes.version_first_released IS 'VersionFirstReleased';
COMMENT ON COLUMN ext.raw_loinc_codes.version_last_changed IS 'VersionLastChanged';

COMMENT ON TABLE ext.raw_jlac11_codes IS 'ext.raw_jlac11_codes';
COMMENT ON COLUMN ext.raw_jlac11_codes.jlac10_code_17 IS 'JLAC10コード(17桁)';
COMMENT ON COLUMN ext.raw_jlac11_codes.jlac11_code IS 'JLAC11コード(17桁)';

COMMENT ON TABLE ext.agency_codes IS 'ext.agency_codes';
COMMENT ON COLUMN ext.agency_codes.agency_code IS 'agency_code';
COMMENT ON COLUMN ext.agency_codes.agency_name IS 'agency_name';
COMMENT ON COLUMN ext.agency_codes.run_id IS 'run_id';

COMMENT ON TABLE ext.raw_designated_agencies IS 'ext.raw_designated_agencies';
COMMENT ON COLUMN ext.raw_designated_agencies.no IS '番号';
COMMENT ON COLUMN ext.raw_designated_agencies.agency_code IS '代行機関番号';
COMMENT ON COLUMN ext.raw_designated_agencies.agency_name IS '機関名';
COMMENT ON COLUMN ext.raw_designated_agencies.postal_code IS '郵便番号';
COMMENT ON COLUMN ext.raw_designated_agencies.phone IS '電話番号';
COMMENT ON COLUMN ext.raw_designated_agencies.address IS '所在地';
COMMENT ON COLUMN ext.raw_designated_agencies.website IS 'ホームページ';
COMMENT ON COLUMN ext.raw_designated_agencies.agency_type IS '団体種別';
COMMENT ON COLUMN ext.raw_designated_agencies.representative_name IS '代表者名';
...
COMMENT ON COLUMN ext.facility_codes.postal_code IS 'postal_code';
...
COMMENT ON COLUMN ext.facility_codes.run_id IS 'run_id';
...
COMMENT ON COLUMN ext.raw_special_health_facility_codes.postal_code IS '郵便番号';
...
COMMENT ON COLUMN ext.hot13_codes.run_id IS 'run_id';
...
COMMENT ON COLUMN ext.jlac10_codes.run_id IS 'run_id';
...
COMMENT ON COLUMN ext.icd10_index_terms.run_id IS 'run_id';
...
COMMENT ON COLUMN ext.icd10_modifier_codes.run_id IS 'run_id';
...
COMMENT ON COLUMN ext.icd10_diagnosis_codes.run_id IS 'run_id';
...
COMMENT ON COLUMN ext.jis_compat_maps.run_id IS 'run_id';
...
COMMENT ON COLUMN ext.houjin_numbers.postal_code IS '22. postal_code';
...
COMMENT ON COLUMN ext.houjin_numbers.run_id IS 'run_id';
...
COMMENT ON TABLE ext.raw_postal_codes IS 'ext.raw_postal_codes';
COMMENT ON COLUMN ext.raw_postal_codes.local_government_code IS '全国地方公共団体コード:JIS X0401、X0402';
COMMENT ON COLUMN ext.raw_postal_codes.old_postal_code5 IS '旧郵便番号(5桁)';
COMMENT ON COLUMN ext.raw_postal_codes.postal_code7 IS '郵便番号(7桁)';
COMMENT ON COLUMN ext.raw_postal_codes.prefecture_katakana IS '都道府県名(カナ)';
COMMENT ON COLUMN ext.raw_postal_codes.city_katakana IS '市区町村(カナ)';
COMMENT ON COLUMN ext.raw_postal_codes.town_katakana IS '町域名(カナ)';
COMMENT ON COLUMN ext.raw_postal_codes.prefecture IS '都道府県名';
COMMENT ON COLUMN ext.raw_postal_codes.city IS '市区町村名';
COMMENT ON COLUMN ext.raw_postal_codes.town IS '町域名';
COMMENT ON COLUMN ext.raw_postal_codes.is_multi_zip IS '複数郵便番号フラグ:一町域が二以上の郵便番号で表される場合の表示（"1": 該当、"0": 該当せず）';
COMMENT ON COLUMN ext.raw_postal_codes.is_koaza IS '小字番地フラグ:小字毎に番地が起番されている町域の表示（"1": 該当、"0": 該当せず）';
COMMENT ON COLUMN ext.raw_postal_codes.is_chome IS '丁目フラグ:丁目を有する町域の場合の表示（"1": 該当、"0": 該当せず）';
COMMENT ON COLUMN ext.raw_postal_codes.is_multi_town IS '複数町域フラグ:一つの郵便番号で二以上の町域を表す場合の表示（"1": 該当、"0": 該当せず）';
COMMENT ON COLUMN ext.raw_postal_codes.update_status IS '更新フラグ:更新の表示（"0": 変更なし、"1": 変更あり、"2": 廃止）';
COMMENT ON COLUMN ext.raw_postal_codes.update_reason IS '更新理由:変更理由（"0": 変更なし、"1": 市政等施行、"2": 住居表示の実施、"3": 区画整理、"4": 郵便区調整等、"5": 訂正、"6": 廃止）';
