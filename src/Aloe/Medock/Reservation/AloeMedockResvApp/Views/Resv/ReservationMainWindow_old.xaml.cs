...
/// </summary>
public partial class ReservationMainWindow_old : Window
{
    ...
    private void ReservationMainWindow_old_OnLoaded(object sender, RoutedEventArgs e)
    {
        this.InitializeScrollViewers();
    }

    private void ReservationMainWindow_old_OnUnloaded(object sender, RoutedEventArgs e)
    {
