...
public class Organization : IAuditableEntity
{
    ...
    [Column("org_name_katakana_compat")][MaxLength(100)] public string OrgNameKatakanaCompat { get; set; } = String.Empty;
    [Column("org_name_display")][MaxLength(100)] public string OrgNameDisplay { get; set; } = String.Empty;
    [Column("org_name_print")][MaxLength(100)] public string OrgNamePrint { get; set; } = String.Empty;
    [Column("org_memo")][MaxLength(1000)] public string OrgMemo { get; set; } = String.Empty;
