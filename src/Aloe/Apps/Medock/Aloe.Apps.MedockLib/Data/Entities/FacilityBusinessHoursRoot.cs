...
public class FacilityBusinessHoursRoot
{
    ...
    public string Start { get; set; } = BusinessHoursConstants.DefaultStartTime;

    /// <summary>就業時間（例: "18:00"）</summary>
    [JsonPropertyName("end")]
    public string End { get; set; } = BusinessHoursConstants.DefaultEndTime;
...
public class LunchHoursItem
{
    ...
    [JsonPropertyName("start")]
    public string Start { get; set; } = BusinessHoursConstants.DefaultLunchStartTime;

    /// <summary>昼休憩終了時間（例: "13:00"）</summary>
    [JsonPropertyName("end")]
    public string End { get; set; } = BusinessHoursConstants.DefaultLunchEndTime;
}
