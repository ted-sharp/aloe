...
public class FacilityAddressConfiguration : IEntityTypeConfiguration<FacilityAddress>
{
    public void Configure(EntityTypeBuilder<FacilityAddress> entity)
    {
        ...
        entity.Property(e => e.AdrTypeCode).HasColumnName("adr_type_code").HasDefaultValue(0);
        entity.Property(e => e.PostalCode).HasColumnName("postal_code").HasMaxLength(7).HasDefaultValue("");
        entity.Property(e => e.Adr1).HasColumnName("adr1").HasMaxLength(100).HasDefaultValue("");
        entity.Property(e => e.Adr2).HasColumnName("adr2").HasMaxLength(100).HasDefaultValue("");
        entity.Property(e => e.Adr3).HasColumnName("adr3").HasMaxLength(100).HasDefaultValue("");
        entity.Property(e => e.AttentionName).HasColumnName("attention_name").HasMaxLength(100).HasDefaultValue("");
        entity.Property(e => e.Tel).HasColumnName("tel").HasMaxLength(20).HasDefaultValue("");
        entity.Property(e => e.Tel2).HasColumnName("tel2").HasMaxLength(20).HasDefaultValue("");
        entity.Property(e => e.Fax).HasColumnName("fax").HasMaxLength(20).HasDefaultValue("");
        entity.Property(e => e.Email).HasColumnName("email").HasMaxLength(255).HasDefaultValue("");
        entity.Property(e => e.AdrMemo).HasColumnName("adr_memo").HasMaxLength(1000).HasDefaultValue("");
        entity.Property(e => e.AdrSeq).HasColumnName("adr_seq").HasDefaultValue(0);
